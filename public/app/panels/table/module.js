define([
  ...
  function (angular, app, _, require, PanelMeta) {
    ...
    var module = angular.module('grafana.panels.table', ['angular-bind-html-compile']);
    ...
    module.controller('TablePanelCtrl', function($scope, templateSrv, $compile, $sce, panelSrv, panelHelper) {
    ...
    $scope.init = function() {
      $scope.costCenterDashboard = true
      panelSrv.init($scope);
      $scope.ready = false;
      $scope.render();
    };
